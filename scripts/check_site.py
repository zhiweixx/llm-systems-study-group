...
def main():
    ...
    for source_name, route, slide_count in (
            ...
            ("week-2-inference.html", "week-2/slides.html", 21)):
    ...
    print(f"Validated {len(pages)} HTML pages, {checked} local links/anchors, 24 Week 1 slides, 21 Week 2 slides, lab downloads, and publication boundaries.")
