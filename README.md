...
| 3 | Multi-GPU parallelism and sharding | [45-slide presentation](week-3-parallelism.html), [speaker notes](week-3-speaker-notes.md), [PyTorch exercise](week-3-tp-exercise.py) |
...
Week 3 includes step-through examples for the tensor-parallel MLP (slide 9), ring attention (24), and expert dispatch, computation, and return (34). Its native SVG diagrams are editable in the source modules and are included in the standalone HTML. Print / PDF uses the completed interactive state.
